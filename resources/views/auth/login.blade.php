...
<div class="auth-wrapper">
    ...
    <div class="login-left">
        <div class="brand-logo text-center mb-2">
            <img src="{{ asset('Assets/Frontend/img/logosmp20.jpeg') }}" alt="Logo">
        </div>
        <h2 class="login-title">Selamat Datang di SMPN 20 Kendari 👋</h2>
<p class="login-sub">Silakan masuk ke akun Anda untuk mengakses Panel Guru</p>
