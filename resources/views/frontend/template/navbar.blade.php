      ...
      <li class="relative group">
        ...
        <ul
         ...
         >
          ...
          <li><a href="{{ route('ekstrakulikuler') }}" class="block px-4 py-2 hover:bg-gray-700">Ekstrakurikuler</a>
          </li>
        </ul>
      </li>
...
<style>
  /* Supaya dropdown gak langsung nutup */
  li.group ul {
